...
function ShoppingList() {
    ...
    return <div className="shoppingListBody">
        { 
            currentActiveItem ?
            <ShoppingListItem name={currentActiveItem.name} image_path={currentActiveItem.image_path} price={currentActiveItem.price}
            handleClick={() => setCurrentActiveItem(undefined)}
